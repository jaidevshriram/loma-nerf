...
class CustomTestLoader(unittest.TestLoader):
    def loadTestsFromTestCase(self, testCaseClass):
        text_suite = super().loadTestsFromTestCase(testCaseClass)

        filtered_suite = unittest.TestSuite()
        for test in text_suite:
            if test._testMethodName in tests_to_run:
...
class Homework3Test(unittest.TestCase):
    ...
    def test_ifelse_side_effects_rev(self):
        ...
        print(_dx.value, 0.3 * math.cos(5.0 * x) * 5)
        print(_dy.value)
    ...
    def test_nested_ifelse_rev(self):
        ...
        print(_dx.value, 0.3 * math.sin(5.0 * x) * 5)
        assert abs(_dx.value - 0.3 * math.cos(5.0 * x) * 5) < epsilon and \
            abs(_dy.value) < epsilon
    ...
    def test_call_stmt_side_effects2(self):
        ...
        # dy = dout * (0.5 * y) * x
        print(_dx.value, (dout * (2 * (2 * x + 1) + 0.25 * y * y)))
        print(_dy.value, (dout * (0.5 * y * x)))
    ...
    def test_call_stmt_array_rev(self):
        ...
        # y = (x * x + x)
        # dx = dy * (2 * x + 1)
        print(_dx.value, _dy.value * (2 * x.value + 1))
    ...
    def test_while_loop_fwd(self):
        ...
        #              cos(x))
        print(out.dval)
        print(x.dval * (math.cos(math.sin(math.sin(math.sin(math.sin(x.val))))) * \
    ...
    def test_while_loop_rev(self):
        ...
        print(_dx.value, dout * (math.cos(math.sin(math.sin(math.sin(math.sin(x))))) * \
